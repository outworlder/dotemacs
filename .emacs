...
(custom-set-faces
 ...
 '(mode-line ((t (:background "gray7" :foreground "DarkSalmon" :box (:line-width 1 :color "grey75") :slant normal :weight normal :height 110 :width normal :foundry "unknown" :family "Monaco"))))
 '(mode-line-buffer-id ((t (:foreground "WhiteSmoke" :weight bold))))
 '(mode-line-inactive ((t (:inherit mode-line :foreground "grey80" :slant italic :weight normal :width normal :foundry "unknown" :family "Monaco"))))
