...
(custom-set-faces
 ...
 '(mode-line ((t (:background "gray7" :foreground "DarkSalmon" :box nil :slant normal :weight normal :height 110 :width normal :foundry "unknown" :family "Monaco"))))
 '(mode-line-buffer-id ((t (:foreground "WhiteSmoke" :weight bold))))
 '(mode-line-inactive ((t (:inherit mode-line :foreground "grey80" :box nil :slant italic :weight normal :width normal :foundry "unknown" :family "Monaco"))))
